...
public class CustomerEditorTests {
	...
	private static final String ADDRESS = "Bel Air";
	...
	private void customerDataWasFilled() {
		this.editor.editCustomer(new Customer(FIRST_NAME, LAST_NAME, ADDRESS));
	}

	private ArgumentMatcher<Customer> customerMatchesEditorFields() {
		return customer -> FIRST_NAME.equals(customer.getFirstName()) && LAST_NAME.equals(customer.getLastName()) && ADDRESS.equals(customer.getAddress());
	}
